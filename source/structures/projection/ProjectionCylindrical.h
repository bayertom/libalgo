...
class ProjectionCylindrical : virtual public Projection <T>
{
        ...
        public:
                ...
                ProjectionCylindrical() : Projection <T> (), cart_pole ( MAX_LAT, 0.0 ), lat0 ( 45.0 ), lat1 ( 45.0 ), lat2 ( 45.0 ) {}
                ProjectionCylindrical ( const T R_, const T lat0_, const T lat1_, const T lat2_, const T latp_, const T lonp_, const T lon0_, const T dx_, const T dy_, const T c_, const char * x_equat_, const char * y_equat_,  const char * projection_name_ ) :
