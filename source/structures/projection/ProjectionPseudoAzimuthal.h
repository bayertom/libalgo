...
{
        public:
                ProjectionPseudoAzimuthal() : Projection <T> () {}
                ProjectionPseudoAzimuthal ( const T R_, const T lon0_, const T dx_, const T dy_, const T c_, const char * x_equat_, const char * y_equat_,  const char * projection_name_ ) :
                        Projection <T> ( R_, lon0_, dx_, dy_, c_, x_equat_, y_equat_, projection_name_ ) {}
