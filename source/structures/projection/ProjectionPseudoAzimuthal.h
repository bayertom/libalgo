...
class ProjectionPseudoAzimuthal : virtual public Projection <T>
{
	...
	protected:
		...
		ProjectionPseudoAzimuthal(const T R_, const T latp_, const T lonp_, const TTransformedLongtitudeDirection lon_dir_, const T lon0_, const T dx_, const T dy_, const T c_, const char * x_equat_, const char * y_equat_, const char * x_equat_postfix_, const char * y_equat_postfix_, 
