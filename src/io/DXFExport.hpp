...
#include "libalgo/src/exceptions/ErrorFileWrite.h"
...
void DXFExport::exportDTToDXF ( const char * file_name, const Container <HalfEdge <T> *> &hl )
{
        ...
        catch ( std::ios_base::failure & )
        {
                ...
                //Throw exception
                throw ErrorFileWrite ( "ErrorFileWrite: can not write the file: ", file_name );
        }
}
...
void DXFExport::exportPointsToDXF(const char * file_name, const Container <Point *, destructable> &points, const typename Point::Type font_height)
{
        ...
        catch ( std::ios_base::failure & )
        {
                ...
                //Throw exception
                throw ErrorFileWrite ( "EFileWritError: can not write the file", file_name );
        }
}
