...
#ifndef ErrorMathMatrixNotSquare_H
#define ErrorMathMatrixNotSquare_H
...
class ErrorMathMatrixNotSquare : public ErrorMathMatrix <TMatrix>
{
        public:

                ErrorMathMatrixNotSquare ( const char * exception_text_, const char * function_text_, const TMatrix &M_ )
                        : ErrorMathMatrix <TMatrix> ( exception_text_, function_text_, M_ ) {}

        public:
                virtual ~ErrorMathMatrixNotSquare() throw() {};
