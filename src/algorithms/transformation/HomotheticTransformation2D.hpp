                ...
                TTransformationKeyHomothetic2D <typename Point1::Type> & key_homothetic )
{
        ...
        {
                throw  ErrorBadData ( "ErrorBadData: not enough points. ", "Can not compute Homothetic 2D transformation key. \n" );
        }

        //Less local points
        if ( n_global > n_local )
        {
                throw  ErrorBadData ( "ErrorBadData: less local points than global points. ", "Can not compute Homothetic 2D transformation key. \n" );
        }
        ...
        {
                throw  ErrorMathZeroDevision <typename Point1::Type> ( "ErrorMathZeroDevision: can not compute Homothetic 2D transformation, ", " divider = ", key_homothetic.J );
        }
...
void HomotheticTransformation2D::transform ( const Container <Point1 *, destructable> &global_points, const Container <Point2 *, destructable2> &local_points, Container <Point3 *, destructable3> &transformed_points, const TTransformationKeyHomothetic2D <typename Point1::Type> & key_homothetic )
{
        ...
        {
                throw ErrorBadData ( "ErrorBadData: list of tranformed points is not empty. ", "Can not compute Homothetic 2D transformation." );
        }
