...
#include "libalgo/src/structures/list/Container.h"

#include "libalgo/src/algorithms/cartanalysis/CartAnalysis.h"
#include "libalgo/src/algorithms/outliers/Outliers.h"

#include "libalgo/src/algorithms/geneticalgorithms/FAnalyzeProjV4DEL.h"
