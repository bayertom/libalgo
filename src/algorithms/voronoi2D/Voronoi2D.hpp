...
#include "libalgo/src/structures/face/VoronoiCell.h"

#include "libalgo/src/algorithms/circle3points/Circle3Points.h"
#include "libalgo/src/algorithms/faceoverlay/FaceOverlay.h"
#include "libalgo/src/algorithms/triangulations2D/DT2D.h"
                        ...
                        do
                        {
                                ...
                                try
                                {
                                                        ...
                                                        max ( EuclDistance::getEuclDistance2D ( q2, q3 ), EuclDistance::getEuclDistance2D ( q3, q1 ) ) ) ) )
                                        {
                                                ...
                                                throw ErrorBadData ( "ErrorBadData: Inappropriate Voronoi vertex, too accute angle", " throw this vertex." ) ;
                                        }
                                }
