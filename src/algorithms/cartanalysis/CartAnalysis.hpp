...
#include "libalgo/src/structures/point/Node3DCartesianProjected.h"
#include "libalgo/src/structures/projection/Sample.h"

#include "libalgo/src/algorithms/cartdistortion/CartDistortion.h"
#include "libalgo/src/algorithms/carttransformation/CartTransformation.h"
#include "libalgo/src/algorithms/geneticalgorithms/DifferentialEvolution.h"
#include "libalgo/src/algorithms/transformation/HomotheticTransformation2D.h"
#include "libalgo/src/algorithms/transformation/HelmertTransformation2D.h"
#include "libalgo/src/algorithms/angle3points/Angle3Points.h"
#include "libalgo/src/algorithms/facearea/FaceArea.h"

#include "libalgo/src/algorithms/turningfunction/TurningFunction.h"
#include "libalgo/src/algorithms/nndistance/NNDistance.h"
#include "libalgo/src/algorithms/innerdistance/InnerDistance.h"
#include "libalgo/src/algorithms/voronoi2D/Voronoi2D.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjJ.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjJ2.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjJ3.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjJ4.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjV.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjV2.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjV3.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/FAnalyzeProjV4.h"
#include "libalgo/src/algorithms/simplexmethod/FAnalyzeProjVS.h"
#include "libalgo/src/algorithms/simplexmethod/FAnalyzeProjV2S.h"
#include "libalgo/src/algorithms/simplexmethod/FAnalyzeProjV3S.h"
#include "libalgo/src/algorithms/simplexmethod/FAnalyzeProjV4S.h"
#include "libalgo/src/algorithms/geneticalgorithms/FAnalyzeProjVDE.h"
#include "libalgo/src/algorithms/geneticalgorithms/FAnalyzeProjV2DE.h"
#include "libalgo/src/algorithms/geneticalgorithms/FAnalyzeProjV3DE.h"
#include "libalgo/src/algorithms/geneticalgorithms/FAnalyzeProjV4DE.h"
#include "libalgo/src/algorithms/nonlinearleastsquares/NonLinearLeastSquares.h"
#include "libalgo/src/algorithms/simplexmethod/SimplexMethod.h"
#include "libalgo/src/algorithms/outliers/Outliers.h"
#include "libalgo/src/algorithms/randompermutation/RandomPermutation.h"

#include "libalgo/src/comparators/sortPointsByID.h"
#include "libalgo/src/comparators/sortPointsByX.h"
#include "libalgo/src/comparators/sortPointsByLat.h"
#include "libalgo/src/comparators/sortPointsByLon.h"
#include "libalgo/src/comparators/sortProjectionPolePositionsByLat.h"
#include "libalgo/src/comparators/sortProjectionPolePositionsByCompCriterium.h"

#include "libalgo/src/comparators/removeUnequalMeridianParallelPointIndices.h"
#include "libalgo/src/comparators/removeProjectionPolePositions.h"
#include "libalgo/src/comparators/findMeridianParallelPointIndices.h"
#include "libalgo/src/comparators/getSecondElementInPair.h"

#include "libalgo/src/comparators/sortSamplesByCrossNearestNeighbourDistanceRatio.h"
#include "libalgo/src/comparators/sortSamplesByAverageNearestNeighbourDistanceRatio.h"
#include "libalgo/src/comparators/sortSamplesByHomotheticTransformationRatio.h"
#include "libalgo/src/comparators/sortSamplesByHelmertTransformationRatio.h"
#include "libalgo/src/comparators/sortSamplesByAngularDifferencesRatio.h"
#include "libalgo/src/comparators/sortSamplesByGNTurningFunctionRatio.h"
#include "libalgo/src/comparators/sortSamplesByNNNGraphRatio.h"
#include "libalgo/src/comparators/sortSamplesBySphereOfInfluenceGraphRatio.h"
#include "libalgo/src/comparators/sortSamplesByVoronoiCellAreaLengthRatio.h"
#include "libalgo/src/comparators/sortSamplesByVoronoiCellTurningFunctionRatio.h"
#include "libalgo/src/comparators/sortSamplesByVoronoiCellTARRatio.h"
#include "libalgo/src/comparators/sortSamplesByVoronoiCellInnerDistanceRatio.h"
#include "libalgo/src/comparators/sortSamplesByAllRatios.h"

#include "libalgo/src/exceptions/ErrorMath.h"

#include "libalgo/src/io/DXFExport.h"
		...
		try
		{
			...
			for (unsigned int i = 0; i < 3; i++)
			{
				...
				if ((i == 0) && (normal_aspect_enabled) || (i == 1) && (transverse_aspect_enabled) || (i == 2) && (oblique_aspect_enabled))
				{
					...
					{
						XMIN.submat(X0MIN, 0, 1); XMAX.submat(X0MAX, 0, 1);
						XMIN(0, 0) = ks * R0; XMAX(0, 0) = 1.0 / ks * R0;

						min_cost = SimplexMethod::NelderMead(FAnalyzeProjV2S <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, HuberFunction, k, IX, output), XMIN, XMAX, W, X, Y, V, iterations, mult * eps, max_iter, output);
					}
					...
					else if (analysis_parameters.analysis_method == SimplexRotMethod)
					{
						...
						min_cost = SimplexMethod::NelderMead(FAnalyzeProjV3S <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, XMIN, XMAX, output), XMIN, XMAX, W, X, Y, V, iterations, mult * eps, max_iter, output);
					}
					...
					else if (analysis_parameters.analysis_method == SimplexRot2Method)
					{
						...
						min_cost = SimplexMethod::NelderMead(FAnalyzeProjV4S <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, R_est, q1, q2, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, HuberFunction, k, IX, output), X0MIN, X0MAX, W, X0, Y, V, iterations, mult * eps, max_iter, output);

						//X0.print();
						X(0, 0) = R_est;  X.submat(X0, 0, 1);
					...
					{
						XMIN.submat(X0MIN(0, 0, 0, 3), 1, 0); XMAX.submat(X0MAX(0, 0, 0, 3), 0, 1);
						...
						min_cost = SimplexMethod::NelderMead(FAnalyzeProjVS <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, output), XMIN, XMAX, W, X, Y, V, iterations, mult * eps, max_iter, output);
					}
	...
	unsigned int & total_created_or_thrown_samples, std::ostream * output)
{
	...
	for (typename TItemsList <Projection <T> *> ::Type::const_iterator i_projections = pl.begin(); i_projections != pl.end(); ++i_projections)
	{
		...
		*output << (*i_projections)->getProjectionName() << ": ";
		...
		const unsigned int population = n_par * XMIN.cols(), max_gen = 2000;
		unsigned int iterations = 0;
				...
				if ((i == 0) && (normal_aspect_enabled) || (i == 1) && (transverse_aspect_enabled) || (i == 2) && (oblique_aspect_enabled))
				{
					...
					if (analysis_parameters.analysis_method == DifferentialEvolutionMethod)
					{
						...
						min_cost = DifferentialEvolution::diffEvolution(FAnalyzeProjV2DE <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, me_function, k, IX, output), XMIN, XMAX, population, eps, max_gen, F, CR, DERand1Strategy, MFDE, W, X, Y, V, XAVER, res_aver, res_max, iterations);
					}
					...
					else if (analysis_parameters.analysis_method == DifferentialEvolutionRotMethod)
					{
						...
						min_cost = DifferentialEvolution::diffEvolution(FAnalyzeProjV3DE <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, XMIN, XMAX, XAVER, output), XMIN, XMAX, population, eps, max_gen, F, CR, DERand1Strategy, MFDE, W, X, Y, V, XAVER, res_aver, res_max, iterations);
					}
					...
					else if (analysis_parameters.analysis_method == DifferentialEvolutionRot2Method)
					{
						...
						min_cost = DifferentialEvolution::diffEvolution(FAnalyzeProjV4DE <T>(nl_test, pl_reference, meridians, parallels, faces_test, *i_projections, R_est, q1, q2, analysis_parameters, aspect, best_sample,
							total_created_and_analyzed_samples_projection, res_evaluation, me_function, k, IX, output), X0MIN, X0MAX, population, eps, max_gen, F, CR, DERand1Strategy, MFDE, W, X0, Y, V, XAVER0, res_aver, res_max, iterations);
		...
		for (unsigned int i_per = 0; i_per < 6; i_per++)
		{
			...
			for (unsigned int i = 0; i < n_tests; i++)
			{
				...
				*/
				...
				//Get projection ID
				const char * proj_text = proj->getProjectionName();
