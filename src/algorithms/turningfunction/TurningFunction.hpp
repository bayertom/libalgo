...
#include "libalgo/src/structures/face/Face.h"

#include "libalgo/src/algorithms/angle3points/Angle3Points.h"
#include "libalgo/src/algorithms/bearing/Bearing.h"
#include "libalgo/src/algorithms/faceperimeter/FacePerimeter.h"
#include "libalgo/src/algorithms/polylinelength/PolyLineLength.h"
                ...
                const TTurningFunctionScaleMethod & scale_method )
{
        ...
        {
                throw ErrorMathZeroDevision <T> ( "ErrorMathZeroDevision: turning function, can not normalize function (1 / perimeter), ", "perimeter = 0.", face_perimeter );
        }
