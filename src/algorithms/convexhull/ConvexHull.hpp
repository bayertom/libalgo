...
#include "libalgo/src/algorithms/pointlineposition/PointLinePosition.h"
#include "libalgo/src/algorithms/pointlinedistance/PointLineDistance.h"
...
void ConvexHull::getConvexHull ( const Container <Point> &nl, Container <Point, NonDestructable > &hull, const bool print_exception, std::ostream * output )
{
        ...
        try
        {
                ...
                if ( nl.size() > 2 )
                {
                        ...
                        {
                                throw ErrorBadData ( "ErrorBadData, can not create convex hull, ", "all points lies on the straight line." );
                        }
                ...
                {
                        throw ErrorBadData ( "ErrorBadData: can not create Convex Hull,", "not enough points: points < 3." );
                }
        }
