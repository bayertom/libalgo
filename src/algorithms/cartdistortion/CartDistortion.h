...
#include "libalgo/src/algorithms/arithmeticparser/ArithmeticParser.h"
...
class CartDistortion
{
        ...
        public:
                template <typename T>
		static T H(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T K(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T Theta(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T S(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T P(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T BM(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T BP(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static TTissotIndicatrix <T> Tiss(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T W(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a_, const T b_, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);

                template <typename T>
		static T Airy(const T step, const char * equation_x_postfix, const char * equation_y_postfix, const char * equat_ftheta_postfix, const char * equat_theta0_postfix,  const T lat, const T lon, const T R, const T a, const T b, const T dx, const T dy, const T c, const T lat0, const T lat1, const T lat2, const T lon0, const bool print_exceptions = false);
