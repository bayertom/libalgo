...
class Node3DCartesian: virtual public Point3DCartesian <T>
{
        ...
        public:
                ...
                Node3DCartesian ( const char * point_label, const T x, const T y, const T z = 0 ) : Point3DCartesian <T> ( point_label, x, y, z ), half_edge ( NULL ), face ( NULL ) { }
                Node3DCartesian ( const char * point_label, const T x, const T y, const T z, HalfEdge <T> * half_edge_, Face <T> *face_ ) : Point3DCartesian <T> ( point_label, x, y, z ),
