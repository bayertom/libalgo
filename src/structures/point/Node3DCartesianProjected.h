...
class Node3DCartesianProjected : public Node3DCartesian <T>, public Point3DCartesianProjected <T>
{
        ...
        public:
                ...
                Node3DCartesianProjected ( const char * point_label_, const T x_, const T y_, const T z_, const T h_, const T k_, const T s_, const T theta_, const TTissotIndicatrix <T> &tiss_, const T w_, HalfEdge <T> *half_edge, Face <T> *face,
